...
a = firedrake.Function(Q).interpolate(smb(max_value(s, (1 - ρ_I / ρ_W) * h)))
...
for step in range(num_steps):
    ...
    s.interpolate(b + h)
    a.interpolate(smb(max_value(s, (1 - ρ_I / ρ_W) * h)))
...
outdir = '/scratch/rd53/wy2165/heard_island/land_terminating/'
